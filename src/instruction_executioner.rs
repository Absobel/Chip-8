...
pub fn decode(
    ...
    *pc += 2;
    ...
    match opcode {
        ...
        3 | 4 => i34::r(instruction, pc, mutex_memory, opcode),
        // 0x5XY0 skip next instruction if VX == VY
        // 0x9XY0 skip next instruction if VX != VY
        5 | 9 => i59::r(instruction, pc, opcode, mutex_memory)?,
        // 0x6XNN set register VX to 0xNN
        6 => i6::r(instruction, *pc, mutex_memory),
        // 0x7XNN add 0xNN to register VX (carry flag is not changed)
        7 => i7::r(instruction, *pc, mutex_memory),
        0x8 => {
            match instruction & 0x000F {
                // 0x8XY0 set VX to VY
                0 => i8_0::r(mutex_memory, *pc, &instruction),
                // 0x8XY1 set VX to VX | VY
                // 0x8XY2 set VX to VX & VY
                // 0x8XY3 set VX to VX ^ VY
                1 | 2 | 3 => i8_123::r(instruction, *pc, mutex_memory),
                ...
                // 0x8XY7           VY - VX
                4 | 5 | 7 => i8_457::r(instruction, *pc, mutex_memory),
                ...
                6 | 0xE => i8_6E::r(instruction, *pc, mutex_memory),
                _ => {
